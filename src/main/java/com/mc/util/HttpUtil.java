...
public class HttpUtil {
	...
	public static final String BASE_URL = "http://222.24.62.120";
	...
	public static String http(String url, Map<String, String> params, String cookie, String referUrl) {
		PrintWriter out = null;
		BufferedReader in = null;
		String result = "";
		URL u = null;
	...
	public static String http(String url, Map<String, String> params, String cookie, String requestType, String host) {
		URL u = null;
		HttpURLConnection con = null;
		// 构建请求参数
		StringBuffer sb = new StringBuffer();
	...
	public static String gethttp(String url,
			String cookie/* , String displaymode */) {
		PrintWriter out = null;
		BufferedReader in = null;
		String result = "";
		URL u = null;
